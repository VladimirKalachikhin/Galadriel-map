...
Этот код, возможно, за исключением некоторых функций, написан без использования ИИ, "лучших практик", ООП и ЕСР.
...
15. [Управление скачиванием карт](#загрузчик-galadrielcache)
16. Интерфейс на русском и других языках
