...
Показывается истинная скорость, истинный или магнитный курс и глубина. Разумеется, соответствующие приборы должны быть подключены к [gpsd](https://gpsd.io/). При наличии только приёмника геопозиционирования доступны истинный курс и скорость.  
...
Можно выставить визуальную и звуковую сигнализацию на некоторые параметры.  
