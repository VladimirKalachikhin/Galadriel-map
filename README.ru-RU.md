...
12. [Разграничение доступа](#разграничение-доступа)
13. Отдельная [приборная панель](#приборная-панель), оптимизированная для устройств с экраном на "электронных чернилах" (E-Ink)
14. [Управление скачиванием карт](#загрузчик-galadrielcache)
15. Интерфейс на русском и других языках
