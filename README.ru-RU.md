...
Проблема вызвана особенностями функционирования демонов [Signal K](https://signalk.org/) и [gpsd](https://gpsd.io/) и касается только сетевых источников данных. Приборы, подключенные непосредственно к [gpsd](https://gpsd.io/) или [Signal K](https://signalk.org/) (если [Signal K](https://signalk.org/) используется вместо [gpsd](https://gpsd.io/), см [Отображение положения](#отображение-положения)), отображаются корректно.
